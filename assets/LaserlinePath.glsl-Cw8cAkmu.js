import{IV as Pe,IR as be,Jj as we,GV as f,I8 as w,IX as Ve,GW as H,GS as r,fB as j,wU as Y,IU as De,HN as C,gz as ee,gA as R,i5 as B,Jk as xe,gi as te,I6 as ie,Hs as M,he as m,hp as v,Jl as ne,z0 as se,K as o,mj as ae,i4 as Ee,ir as ye,gB as Le,dE as re,go as le,i2 as Se,IS as Ce,x6 as Me,Hq as Ae,Ig as $e,GR as F,eH as Re,GY as oe,GZ as ce,_ as he,pf as Te,ey as G,is as q,ag as c,al as z,kf as de,kd as pe,dJ as Ie,dD as I,lB as Oe,HB as qe,lE as Ue,Jm as je,Hb as D,I$ as ze,J0 as J,Jn as Ne,mh as We,Jo as T,Jp as He,il as Be,v0 as Fe,io as Ge,ip as Je,iq as ke,it as Xe,ah as A,Jq as Ze,eA as k}from"./index-BG8eAma1.js";import{t as Ke}from"./VisualElement-DctXtZqo.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
