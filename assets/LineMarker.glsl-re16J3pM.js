import{wU as ee,Ie as te,If as ie,GP as re,GN as ae,Ig as se,Ih as oe,GS as o,I7 as ne,Hq as ce,I6 as le,GR as _,Ii as pe,Ij as de,Hu as N,GQ as he,GT as ve,GU as ue,HN as me,GW as fe,Ik as U,Il as j,Im as ge,In as Se,Hv as Pe,kd as ye,GY as we,kf as _e,GZ as ze,_ as xe,G_ as L,G$ as R,H0 as $e,H1 as E,H2 as M,Hx as be,H4 as Te,H5 as ke,H6 as Ve,H8 as k,H9 as Oe,Io as De,Ip as G,Iq as q,Ir as We,Is as Ce,It as Le,au as c,ax as Me,Ha as Ie,Hb as d,gA as Ae,Hy as He,Iu as B,rH as Fe,HZ as Ne,Iv as Ue,He as je,dg as Y,li as Re,gU as Q,o as Z,Iw as Ee}from"./index-Ca4GzoPQ.js";function J(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
