import{IV as Pe,IR as be,Jj as we,GV as f,I8 as w,IX as Ve,GW as H,GS as r,ff as j,wU as Q,IU as De,HN as C,gd as ee,ge as R,hL as B,Jk as xe,fY as te,I6 as ie,Hs as M,gU as m,h3 as v,Jl as ne,z0 as se,o,mj as ae,hK as Ee,i3 as Le,gf as ye,dh as re,g2 as le,hI as Se,IS as Ce,x6 as Me,Hq as Ae,Ig as $e,GR as F,em as Re,GY as oe,GZ as ce,_ as he,pf as Te,ed as G,i4 as q,au as c,ax as z,kf as de,kd as pe,dm as Ie,dg as I,lB as Oe,HB as qe,lE as Ue,Jm as je,Hb as D,I$ as ze,J0 as J,Jn as Ne,mh as We,Jo as T,Jp as He,h_ as Be,v0 as Fe,i0 as Ge,i1 as Je,i2 as ke,i5 as Xe,aw as A,Jq as Ye,ef as k}from"./index-Ca4GzoPQ.js";import{t as Ze}from"./VisualElement-C1kuLVYU.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=j(6);function fe(t){const e=new Q;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new M("angleCutoff",s=>$(s)),new C("heightPlane",(s,a)=>ge(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new M("angleCutoff",i=>$(i)),new C("pointDistanceSphere",(i,s)=>Ke(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
